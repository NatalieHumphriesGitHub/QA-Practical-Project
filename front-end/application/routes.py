...
def index():
    ...
    team_score = requests.post('http://score-generator:5000/team-scores', json=home_team + away_team) #we're posting 2 keys to the team score function, which will then return 2 values
    ...
    return render_template('index.html', result = result, games = games, home_team = home_team, away_team=away_team, home_team_score=home_team_score, away_team_score=away_team_score)